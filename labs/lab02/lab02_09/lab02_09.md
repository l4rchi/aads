...
def main():
    ...
    while True:
        ...
        choice = input("Введите ваш выбор: ")  # Запрос пользователя на выбор операции
        ...
        if choice == '1':
            ...
            result_list = multiply_lists(list1, list2)  # Вычисление результата умножения двух списков
